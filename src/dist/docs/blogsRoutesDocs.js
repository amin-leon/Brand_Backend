...
exports.blogsRoutesDocs = void 0;
const createNewBlog = {
    tags: ['Blog'],
...
exports.blogsRoutesDocs = {
    "/blogs/new": {
        post: Object.assign(Object.assign({}, createNewBlog), { security: [{ bearerAuth: [] }] })
    },
    "/blogs/update/{id}": {
        put: Object.assign(Object.assign({}, updateBlog), { security: [{ bearerAuth: [] }] })
    },
    "/blogs/delete/{id}": {
        delete: Object.assign(Object.assign({}, deleteBlog), { security: [{ bearerAuth: [] }] })
    },
    "/blogs/all": {
        get: getAllBlogs
    },
    ...
    "/blogs/blog/comment/{id}": {
        put: Object.assign(Object.assign({}, commentBlog), { security: [{ bearerAuth: [] }] })
    },
    "/blogs/blog/like/{id}": {
        put: likeBlog
    },
