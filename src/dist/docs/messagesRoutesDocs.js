...
exports.messageDocs = {
    ...
    '/messages/all': {
        get: Object.assign(Object.assign({}, getAllMessages), { security: [{ bearerAuth: [] }] }),
    },
    '/messages/delete/{id}': {
        delete: Object.assign(Object.assign({}, deleteMessage), { security: [{ bearerAuth: [] }] }),
    },
    '/messages/read/{id}': {
        put: readMessage,
    },
